...
// よかったのかが分からなくなります。
//
//   🟢 収録データ … 収録の実データ、または経路検索・時刻表で取れた値
//   🟡 目安      … 分類ごとの目安、距離からの計算
...
// 言葉づかいについて。
//
// いちばん上の段は「確認済み」と書いていました。けれど、このアプリが
// 確認したのは**収録した時点の値**であって、あなたが行く日のことでは
// ありません。営業時間は季節で動き、ダイヤは改正され、臨時休業もあります。
// 「確認済み」と言い切ると、その責任まで引き受けたことになります。
